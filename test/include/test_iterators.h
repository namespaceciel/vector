...
class cpp17_output_iterator {
 ...
 public:
  ...
  template <class U>
  constexpr cpp17_output_iterator(const cpp17_output_iterator<U>& u) : it_(u.it_), tracker_(u.tracker_) {}
  ...
  constexpr cpp17_output_iterator operator++(int) { return cpp17_output_iterator(it_++); }

  friend constexpr It base(const cpp17_output_iterator& i) { return i.it_; }
...
class cpp17_input_iterator {
 ...
 public:
  ...
  template <class U, class T>
  constexpr cpp17_input_iterator(const cpp17_input_iterator<U, T>& u) : it_(u.it_), tracker_(u.tracker_) {}
  ...
  constexpr cpp17_input_iterator operator++(int) { return cpp17_input_iterator(it_++); }

  friend constexpr bool operator==(const cpp17_input_iterator& x, const cpp17_input_iterator& y) {
    return x.it_ == y.it_;
  }
  friend constexpr bool operator!=(const cpp17_input_iterator& x, const cpp17_input_iterator& y) {
    return x.it_ != y.it_;
  ...
  friend constexpr It base(const cpp17_input_iterator& i) { return i.it_; }
...
class forward_iterator {
 ...
 public:
  ...
  template <class U>
  constexpr forward_iterator(const forward_iterator<U>& u) : it_(u.it_), tracker_(u.tracker_) {}
  ...
  constexpr forward_iterator operator++(int) { return forward_iterator(it_++); }

  friend constexpr bool operator==(const forward_iterator& x, const forward_iterator& y) { return x.it_ == y.it_; }
  friend constexpr bool operator!=(const forward_iterator& x, const forward_iterator& y) { return x.it_ != y.it_; }

  friend constexpr It base(const forward_iterator& i) { return i.it_; }
...
class bidirectional_iterator {
 ...
 public:
  ...
  template <class U>
  constexpr bidirectional_iterator(const bidirectional_iterator<U>& u) : it_(u.it_), tracker_(u.tracker_) {}
  ...
  constexpr bidirectional_iterator operator++(int) { return bidirectional_iterator(it_++); }
  constexpr bidirectional_iterator operator--(int) { return bidirectional_iterator(it_--); }
  ...
  friend constexpr It base(const bidirectional_iterator& i) { return i.it_; }
...
class random_access_iterator {
 ...
 public:
  ...
  template <class U>
  constexpr random_access_iterator(const random_access_iterator<U>& u) : it_(u.it_), tracker_(u.tracker_) {}
  ...
  constexpr random_access_iterator operator++(int) { return random_access_iterator(it_++); }
  constexpr random_access_iterator operator--(int) { return random_access_iterator(it_--); }
  ...
  friend constexpr random_access_iterator operator+(random_access_iterator x, difference_type n) {
    x += n;
    return x;
  }
  friend constexpr random_access_iterator operator+(difference_type n, random_access_iterator x) {
    x += n;
    return x;
  }
  friend constexpr random_access_iterator operator-(random_access_iterator x, difference_type n) {
  ...
  friend constexpr difference_type operator-(random_access_iterator x, random_access_iterator y) {
    return x.it_ - y.it_;
  }

  friend constexpr bool operator==(const random_access_iterator& x, const random_access_iterator& y) {
    return x.it_ == y.it_;
  }
  friend constexpr bool operator!=(const random_access_iterator& x, const random_access_iterator& y) {
    return x.it_ != y.it_;
  ...
  friend constexpr It base(const random_access_iterator& i) { return i.it_; }
...
class three_way_random_access_iterator {
 ...
 public:
  ...
  template <class U>
  constexpr three_way_random_access_iterator(const three_way_random_access_iterator<U>& u)
      : it_(u.it_), tracker_(u.tracker_) {}

  template <class U, class = typename std::enable_if<std::is_default_constructible<U>::value>::type>
  constexpr three_way_random_access_iterator(three_way_random_access_iterator<U>&& u)
      : it_(std::move(u.it_)), tracker_(std::move(u.tracker_)) {
    u.it_ = U();
  }
  ...
  constexpr three_way_random_access_iterator operator++(int) { return three_way_random_access_iterator(it_++); }
  constexpr three_way_random_access_iterator operator--(int) { return three_way_random_access_iterator(it_--); }
  ...
  friend constexpr three_way_random_access_iterator operator+(three_way_random_access_iterator x, difference_type n) {
    x += n;
    return x;
  }
  friend constexpr three_way_random_access_iterator operator+(difference_type n, three_way_random_access_iterator x) {
    x += n;
    return x;
  }
  friend constexpr three_way_random_access_iterator operator-(three_way_random_access_iterator x, difference_type n) {
  ...
  friend constexpr difference_type operator-(three_way_random_access_iterator x, three_way_random_access_iterator y) {
    return x.it_ - y.it_;
  }

  friend constexpr bool operator==(const three_way_random_access_iterator& x,
                                   const three_way_random_access_iterator& y) {
    return x.it_ == y.it_;
  }
  friend constexpr bool operator<(const three_way_random_access_iterator& x,
                                  const three_way_random_access_iterator& y) {
  ...
  friend constexpr std::strong_ordering operator<=>(const three_way_random_access_iterator& x,
                                                    const three_way_random_access_iterator& y) {
  ...
  friend constexpr It base(const three_way_random_access_iterator& i) { return i.it_; }
...
class three_way_contiguous_iterator {
 ...
 public:
  ...
  friend constexpr three_way_contiguous_iterator operator+(three_way_contiguous_iterator x, difference_type n) {
    x += n;
    return x;
  }
  friend constexpr three_way_contiguous_iterator operator+(difference_type n, three_way_contiguous_iterator x) {
    x += n;
    return x;
  }
  friend constexpr three_way_contiguous_iterator operator-(three_way_contiguous_iterator x, difference_type n) {
  ...
  friend constexpr difference_type operator-(three_way_contiguous_iterator x, three_way_contiguous_iterator y) {
    return x.it_ - y.it_;
  }

  friend constexpr auto operator<=>(const three_way_contiguous_iterator& x, const three_way_contiguous_iterator& y) {
    return x.it_ <=> y.it_;
  }
  friend constexpr bool operator==(const three_way_contiguous_iterator& x, const three_way_contiguous_iterator& y) {
    return x.it_ == y.it_;
  }
...
struct ThrowingIterator {
  ...
  constexpr ThrowingIterator() : begin_(nullptr), end_(nullptr), current_(nullptr), action_(TADereference), index_(0) {}
  constexpr explicit ThrowingIterator(const T* first, const T* last, int index = 0,
                                      ThrowingAction action = TADereference)
      : begin_(first), end_(last), current_(first), action_(action), index_(index) {}
  constexpr ThrowingIterator(const ThrowingIterator& rhs)
      : begin_(rhs.begin_), end_(rhs.end_), current_(rhs.current_), action_(rhs.action_), index_(rhs.index_) {}

  constexpr ThrowingIterator& operator=(const ThrowingIterator& rhs) {
  ...
  constexpr friend bool operator==(const ThrowingIterator& a, const ThrowingIterator& b) {
  ...
  constexpr friend bool operator!=(const ThrowingIterator& a, const ThrowingIterator& b) { return !(a == b); }
...
struct NonThrowingIterator {
  ...
  explicit NonThrowingIterator(const T* first, const T* last) : begin_(first), end_(last), current_(first) {}
  NonThrowingIterator(const NonThrowingIterator& rhs) : begin_(rhs.begin_), end_(rhs.end_), current_(rhs.current_) {}

  NonThrowingIterator& operator=(const NonThrowingIterator& rhs) noexcept {
    begin_ = rhs.begin_;
    end_ = rhs.end_;
    current_ = rhs.current_;
    return *this;
  ...
  friend bool operator==(const NonThrowingIterator& a, const NonThrowingIterator& b) noexcept {
    bool atEndL = a.current_ == a.end_;
    bool atEndR = b.current_ == b.end_;
    if (atEndL != atEndR) return false;  // one is at the end (or empty), the other is not.
    if (atEndL) return true;             // both are at the end (or empty)
  ...
  friend bool operator!=(const NonThrowingIterator& a, const NonThrowingIterator& b) noexcept { return !(a == b); }
...
class operation_counting_iterator {
 public:
  ...
  using iterator_concept = std::conditional_t<
      std::contiguous_iterator<It>, std::contiguous_iterator_tag,
      std::conditional_t<
          std::random_access_iterator<It>, std::random_access_iterator_tag,
  ...
  friend constexpr difference_type operator-(operation_counting_iterator const& x, operation_counting_iterator const& y)
  ...
  constexpr void record_equality_comparison() const {
    if (counts_ != nullptr) ++counts_->equal_cmps;
  }
...
class Iterator {
 ...
 private:
  ...
  constexpr Iterator(int* p, int* iter_moves, int* iter_swaps)
      : ptr_(p), iter_moves_(iter_moves), iter_swaps_(iter_swaps) {}
 ...
 public:
  ...
  constexpr Iterator operator-(difference_type n) const { return Iterator(ptr_ - n, iter_moves_, iter_swaps_); }
  constexpr difference_type operator-(Iterator rhs) const { return ptr_ - rhs.ptr_; }
  ...
  constexpr friend auto operator<=>(const Iterator& lhs, const Iterator& rhs) { return lhs.ptr_ <=> rhs.ptr_; }
};
...
template <class Base>
  requires std::derived_from<typename std::iterator_traits<Base>::iterator_category, std::input_iterator_tag>
...
class throw_on_move_iterator : public iterator_wrapper<throw_on_move_iterator<Iter>, Iter> {
 ...
 public:
  ...
  throw_on_move_iterator(throw_on_move_iterator&& other)
    ...
    if (moves_until_throw_ == -1) throw iterator_error("throw_on_move_iterator");
  }
