...
constexpr bool tests() {
  {
    ...
    ciel::vector<MoveOnly, test_allocator<MoveOnly> > l2(std::move(l), test_allocator<MoveOnly>(6));
    assert(l2 == lo);
    assert(!l.empty());
  ...
  }
  {
    ...
    ciel::vector<MoveOnly, test_allocator<MoveOnly> > l2(std::move(l), test_allocator<MoveOnly>(5));
    assert(l2 == lo);
    assert(l.empty());
  ...
  }
  {
    ...
    ciel::vector<MoveOnly, other_allocator<MoveOnly> > l2(std::move(l), other_allocator<MoveOnly>(4));
    assert(l2 == lo);
    assert(!l.empty());
  ...
  }
  {
    ...
    ciel::vector<MoveOnly, min_allocator<MoveOnly> > l2(std::move(l), min_allocator<MoveOnly>());
    assert(l2 == lo);
    assert(l.empty());
  ...
  }
  {
    ...
    ciel::vector<MoveOnly, safe_allocator<MoveOnly> > l2(std::move(l), safe_allocator<MoveOnly>());
    assert(l2 == lo);
    assert(l.empty());
