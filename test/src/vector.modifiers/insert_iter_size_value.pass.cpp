...
constexpr bool tests() {
  {
    ...
    ciel::vector<int>::iterator i = v.insert(v.cbegin() + 10, 5, 1);
    assert(v.size() == 105);
    assert(i == v.begin() + 10);
    int j;
  ...
  }
  {
    ...
    ciel::vector<int, limited_allocator<int, 300>>::iterator i = v.insert(v.cbegin() + 10, 5, 1);
    assert(v.size() == 105);
    assert(i == v.begin() + 10);
    int j;
    for (j = 0; j < 10; ++j) assert(v[j] == 0);
  ...
  }
  {
    ...
    ciel::vector<int, min_allocator<int>>::iterator i = v.insert(v.cbegin() + 10, 5, 1);
    assert(v.size() == 105);
    assert(i == v.begin() + 10);
    int j;
    for (j = 0; j < 10; ++j) assert(v[j] == 0);
  ...
  }
  {
    ...
    ciel::vector<int, safe_allocator<int>>::iterator i = v.insert(v.cbegin() + 10, 5, 1);
    assert(v.size() == 105);
    assert(i == v.begin() + 10);
    int j;
    for (j = 0; j < 10; ++j) assert(v[j] == 0);
